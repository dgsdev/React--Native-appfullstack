...
function Login({ navigation }) {
  ...
  function autenticacao() {
    if (apiusuario.usuario === usuario && apiusuario.email === email && apiusuario.senha === senha) {
  ...
  return (
    ...
    <ImageBackground style={styles.container}>
      ...
      <View style={styles.divlogo}>
        ...
        <Image source={require("../../../assets/css.png")} style={styles.logo}></Image>

        <Image source={require("../../../assets/js.png")} style={styles.logo}></Image>
